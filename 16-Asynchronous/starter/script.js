...
createImage('img/img-1.jpg')
  .then(img => {
    ...
    return wait(2); // seting timer to hind the image after 2 seconds
  })
  .then(() => {
...
(async function () {
  const res = await Promise.race([
    getJSON(`https://countries-api-836d.onrender.com/countries/name/bulgaria`),
    getJSON(`https://countries-api-836d.onrender.com/countries/name/russia`),
    getJSON(`https://countries-api-836d.onrender.com/countries/name/moldova`),
  ]);
  console.log(res[0]);
})();
